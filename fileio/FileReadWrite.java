...
public class FileReadWrite
{
  ...
  public void writeInFile(int s,String x,int y)
  {
    /*
    ...
    */
    try
    {
      file = new File("fileio/delivery.txt");  //Declaring a file named named History.txt for creating.
  ...
  public void searchFromFile(String a)
  {

    String line="";
    try
    {
      FileInputStream fi= new FileInputStream("C:\\Desktop\\JAVA\\tailor\\fileio\\delivery.txt");
